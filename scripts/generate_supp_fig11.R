...
#Plotting Supplementary Figure 11 (transcript-level coverage distribution) (realistically simulated libraries)
supp_fig11 <- ggplot(transcript_coverages, aes(x = coverage, group = replicate, color = replicate)) +
...
ggsave(supp_fig11, file = "Supplementary_Figure_11.tiff", height = 4, width = 6, dpi = 600, bg = "white")
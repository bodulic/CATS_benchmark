...
|--------------------------------------------------------------------------------------|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| `merged_controlled_simulated_transcript_scores_for_figure2.tsv`                      | Figure 2, Supp. Figures 1-2                     | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_controlled_simulated_transcript_scores_for_figure2.tsv.gz)                      |
| `merged_realistically_simulated_transcript_scores_for_figure3.tsv`                   | Figure 3 (a-c)                                  | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_realistically_simulated_transcript_scores_for_figure3.tsv.gz)                   |
| `merged_public_transcript_scores_for_figure3.tsv`                                    | Figure 3d, Supp. Figure 3                       | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_public_transcript_scores_for_figure3.tsv.gz)                                    |
| `mutation_analysis_CATS_rf_transcript_scores_for_figure4.tsv`                        | Figure 4                                        | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/mutation_analysis_CATS_rf_transcript_scores_for_figure4.tsv.gz)                        | 
| `merged_cats_rb_controlled_simulated_assembly_scores_for_figures_6_7.tsv`            | Figure 6 (a-c), Figure 7, Supp. Figures 4-6,8,9 | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_cats_rb_controlled_simulated_assembly_scores_for_figures_6_7.tsv.gz)            |
| `merged_cats_rb_realistically_simulated_assembly_scores_for_figure6.tsv`             | Figure 6d, Supp. Figure 7                       | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_cats_rb_realistically_simulated_assembly_scores_for_figure6.tsv.gz)             |
| `merged_cats_rb_realistically_simulated_assembly_scores_per_library_for_figure6.tsv` | Figure 6e                                       | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_cats_rb_realistically_simulated_assembly_scores_per_library_for_figure6.tsv.gz) |
| `merged_cats_rb_public_assembly_scores_for_figure6.tsv`                              | Figure 6f                                       | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_cats_rb_public_assembly_scores_for_figure6.tsv.gz)                              |
| `controlled_simulated_assembly_cats_rf_f_scores_for_figure7.tsv`                     | Figure 7, Supp. Figures 8,9                     | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/controlled_simulated_assembly_cats_rf_f_scores_for_figure7.tsv.gz)                     |
| `merged_cats_rb_simulated_mutated_assembly_scores_for_figure6.tsv`                   | Figure 6g                                       | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/merged_cats_rb_simulated_mutated_assembly_scores_for_figure6.tsv.gz)                   |
...
| `cats_rf_transcript_scores_for_supp_figure11.tsv`                                    | Supp. Figure 11                                 | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/cats_rf_transcript_scores_for_supp_figure11.tsv.gz)                                    |
| `transcript_f_scores_for_supp_figure11.tsv`                                          | Supp. Figure 11                                 | [Download](http://hex.bioinfo.hr/~kbodulic/CATS_benchmark_tables/transcript_f_scores_for_supp_figure11.tsv.gz)                                          |
...
The tables have also been deposited to Zenodo (10.5281/zenodo.16786150)

...
find ../simulated_data -type f -name "realistic_sim_*[1-4]_RSP_f_scores" -exec awk -F'\t' 'BEGIN{OFS="\t"} FNR==1 && NR==1 {print $0,"filename"} FNR==1 {next} {n=split(FILENAME,a,"/"); print $0,a[n]}' {} + | cut -f 1,10,11 > transcript_f_scores_for_supp_figure11.tsv
